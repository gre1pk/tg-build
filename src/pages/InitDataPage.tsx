...
import { initDataRaw as _initDataRaw, initDataState as _initDataState, type User, useSignal } from '@telegram-apps/sdk-react';
...
export const InitDataPage: FC = () => {
  ...
  const chatRows = useMemo<DisplayDataRow[] | undefined>(() => {
    return !initDataState?.chat ? undefined : Object.entries(initDataState.chat).map(([title, value]) => ({ title, value }));
  }, [initDataState]);
